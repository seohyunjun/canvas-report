...
(function(){
'use strict';
var R=REPORT,D=R.data,S=D.spec,rows=D.rows,KO=/^ko(?:-|$)/i.test(S.metadata.locale||'');
var L=KO?{grain:'단위',table:'표',method:'방법',methodTitle:'데이터 기준, 산식과 한계',basis:'데이터 기준',formulas:'산식',limits:'한계',data:' 데이터'}:{grain:'Grain',table:'Table',method:'Method',methodTitle:'Basis, formulas, and limits',basis:'Basis',formulas:'Formulas',limits:'Limits',data:' data'};
